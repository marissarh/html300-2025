    ...
    <div><h1>{{ msg }}</h1>
     ...
     <nav class=" nav">
            <ul class="nav__list">
                ...
                <router-link to="/images" class="nav__item">Images</router-link>
                <router-link to="/accordion" class="nav__item">Accordion</router-link>
                <router-link to="/grid" class="nav__item">Grid System</router-link>
            </ul>
        </nav>
        <div class="bodyIndex">
